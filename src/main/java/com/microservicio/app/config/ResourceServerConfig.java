...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/v1/aplicacion/usuario/registro").permitAll().and().requestMatchers().antMatchers("/v1/**").and()
				.authorizeRequests().antMatchers(OPEN_ENDPOINTS_MATCHER).authenticated().and().sessionManagement();
	}
